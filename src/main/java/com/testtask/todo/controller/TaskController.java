...
public class TaskController {
    ...
    @Operation(
            summary = "Получение задачи",
            description = "Получение задачи по имени"
    )
    public TaskDto getTaskByName(@PathVariable @Parameter(description = "Название задачи") String name) {
    ...
    @Operation(
            ...
            description = "Возвращает список задач с пагинацией"
    )
